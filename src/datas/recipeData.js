export const recipeData = [
  {
    ...
    cookTime: "25 minutes",
    ingredients: [
      "- 60 g de queues de fraises avec un peu de chair",
  ...
  },
  {
    ...
    prepTime: "5 minutes",
    ingredients: [
      "- 4 cuillères à soupe de queues de cerises,",
      "- 500 ml d’eau",
    ],
    instructions: [
      "Faites bouillir 500 ml d’eau.",
      "Versez les queues, rincées au préalable, dans l’eau bouillante.",
      "Couvrez et laissez infuser 5 bonnes minutes.",
      "Filtrez et dégustez pour profiter de tous les bienfaits de cette boisson ",
    ],
  },
  // Autres recettes ici
];
